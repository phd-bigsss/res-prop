...
*Data, variables, and methods*. It is expected to employ data from the "Social Networks and Social Resources" module from the International Social Survey Programme [@isspresearchgroup_international_2019], a large-scale nationally representative sample of 44,492 individuals in 33 countries. 
...
**Title:** Diversity, reference groups, and policy preferences: A vignette design
